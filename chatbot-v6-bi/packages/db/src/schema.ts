...
const schemaName = 'ai_chatbot_v6_bi';
...
export const user = createTable('bi_User', {
...
export const chat = createTable('bi_Chat', {
...
export const message = createTable('bi_Message', {
  id: uuid('id').primaryKey().notNull().defaultRandom(),
  chatId: uuid('chatId')
    .notNull()
    .references(() => chat.id),
